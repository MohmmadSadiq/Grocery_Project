...
{
    /// <summary>
    /// Modal dialog that wraps <see cref="ctrlAddEditSupplier"/>.
    ...
    public partial class frmAddEditSupplier : Form
    {
        ...
        public clsSupplier? SavedSupplier { get; private set; }

        // ── Fields ──────────────────────────────────────────────────────────────
        private ctrlAddEditSupplier _ctrl = null!;
        ...
        {
            InitializeComponent();
            _ctrl = new ctrlAddEditSupplier();
            _BootstrapForm();
        }

        /// <summary>Open in Edit mode for an existing supplier.</summary>
        public frmAddEditSupplier(int supplierID)
        {
            InitializeComponent();
            _ctrl = new ctrlAddEditSupplier(supplierID);
            _BootstrapForm();
        }
        ...
        private void _BootstrapForm()
        {
            ...
            _ctrl.SupplierSaved += (s, supplier) =>
            {
