        ...
        public static int AddNewBatch(int PurchaseID, int ProductUnitID, decimal TotalQuantity, decimal UniteCostPrice, DateTime? ProductionDate, DateTime? ExpiryDate, string? BatchNumber)
        {
            ...
            using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
            {
                using (SqlCommand command = new SqlCommand("spBatch_AddNew", connection))
                {
                    ...
                    command.Parameters.Add("@TotalQuantity", System.Data.SqlDbType.VarChar).Value = (object?)TotalQuantity ?? DBNull.Value;
                    command.Parameters.Add("@UniteCostPrice", System.Data.SqlDbType.VarChar).Value = (object?)UniteCostPrice ?? DBNull.Value;
                    ...
                    command.Parameters.Add("@BatchNumber", System.Data.SqlDbType.VarChar).Value = (object?)BatchNumber ?? DBNull.Value;
